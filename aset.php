...
<section class="home-section">
    ...
    <div class="home-content">
        <div class="dashboard-content">
            ...
            <form method="GET" action="aset.php">
            ...
            <div class="table-ds">
                ...
                if(isset($_GET['kata_cari'])) {
                    ...
                    JOIN pengadaan ON pengadaan.id_pengadaan = aset.id_pengadaan WHERE id_aset like '%".$kata_cari."%' OR nama_aset like '%".$kata_cari."%' OR lokasi like '%".$kata_cari."%' OR nilai_awal like '%".$kata_cari."%' OR kondisi like '%".$kata_cari."%' OR nama_rekanan like '%".$kata_cari."%' OR no_dokumen like '%".$kata_cari."%' ORDER BY id_aset ASC";
				} else {
